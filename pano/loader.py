...
def code_fetch(address, network="mainnet"):
    ...
    # web3 = Web3(Web3.HTTPProvider("http://103.44.247.5:18456", request_kwargs={'timeout': 60}))
    web3 = Web3(Web3.HTTPProvider("http://172.16.42.13:8545", request_kwargs={'timeout': 60}))
